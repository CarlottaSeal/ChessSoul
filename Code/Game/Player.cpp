...
void Player::UpdateFreeCamera(float deltaSeconds)
{
	...
	m_orientation.m_yawDegrees -= mouseDeltaX * 0.075f;//* deltaSeconds;
	m_orientation.m_pitchDegrees += mouseDeltaY * 0.075f;//deltaSeconds;
...
void Player::ResetPositionAndOrientation(Vec3 pos, EulerAngles orientation)
{
	m_position = pos;
